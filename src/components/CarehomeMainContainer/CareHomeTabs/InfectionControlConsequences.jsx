...
export default function InfectionControlConsequence() {
  return (  < div >
    <Box style= {containerStyle}>
        ...
        <div style={{display:"flex" , justifyContent: "space-between" , marginTop:"20px"}}>
                ...
                <div className="pill" >
                    <div className="drop-menu-label" for="cars1">Proximity</div>
                    ...
                    <div className="drop-menu-label" for="cars2">Duration of contact</div>
                ...
                <div  style={{display:"inline-block"}}>
                    ...
                    <Typography   sx={{ mb: 1.5 ,  color:"#435282" , textDecoration:"underline" , fontWeight:"bold" ,  display:"inline-block" }}  >
                        Download report 
                        <div className="icon-container" style={{  display:"inline-block" }}>
                            <DownloadIcon className="download-icon" sx={{color:"#435282"}}   />
                        </div>
                    </Typography>
                    </div>
        ...
        <Grid container justifyContent="center" spacing={5} >
            ...
            <Grid item xs={12} sm={9}   >
                ...
                <br/>
                <Card sx={{ minWidth: 275 }}>
                    <Grid container style = {{backgroundColor:"#F0F2F6",padding:"20px"}} >
                            <Grid item xs={2} >
                        ...
                        Array.from({ length: 4 }, (_, index) => index).map((number) => (
                            <div>
                                ...
                                <div style={{
                                    ...
                                    <span >
                                        <Typography   sx={{ mb: 1.5 ,  color:"#57BEC8" , textDecoration:"underline" , fontWeight:"bold" , marginLeft:"20px" }}  >
                                        Isolate
                                        </Typography>
                                    </span>
                                </div>  
                                ...
                                <Grid item xs={2} >
                                    ...
                                    <span >
                                        <Typography   sx={{ mb: 1.5 ,  color:"blue" , textDecoration:"underline"  }}  >
                                            View replay
                                        </Typography>
                                    </span>
                                    <ArrowForwardIosIcon sx={{color:"#919191" , marginLeft:"8px"}} />
                                    </div>  
                                </Grid>
