        ...
        <div style={{display:"flex" , justifyContent: "space-between" , marginTop:"20px"}}>
                ...
                <button className="add-new-infection-button">
                    <div style={{
                                        ...
                                        <span >
                                            <Typography   sx={{ mb: 1.5 ,  color:"white" , textDecoration:"underline" , fontWeight:"bold" , marginLeft:"5px" }}  >
                ...
                <div class="search-wrapper">
                    ...
                    <button><SearchRoundedIcon sx={{color:"gray"}}/></button>
                </div>
                        ...
                        Array.from({ length: 4 }, (_, index) => index).map((number) => (
                            <div>
                                ...
                                <Grid item xs={2} >
                                    ...
                                    <span >
                                        <Typography   sx={{ mb: 1.5 ,  color:"blue" , textDecoration:"underline" ,  marginLeft:"8px"   }}  >
                                            List of contacts 
                                        </Typography>
                                    </span>
                                    </div>  
